...
package com.harysaydev.amikpgrikbmquiz.socialmedia.controllers;
...
import com.harysaydev.amikpgrikbmquiz.socialmedia.main.interactors.PostInteractor;
...
public class LikeController {
    ...
    private void showWarningMessage(BaseActivity baseActivity, int messageId) {
        if (baseActivity instanceof MainActivity_Socialmedia) {
            ((MainActivity_Socialmedia) baseActivity).showFloatButtonRelatedSnackBar(messageId);
        } else {
