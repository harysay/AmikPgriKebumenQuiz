package com.harysaydev.amikpgrikbmquiz.chat.Chat;
...
import com.harysaydev.amikpgrikbmquiz.chat.Adapter.MessageAdapter;
import com.harysaydev.amikpgrikbmquiz.chat.Model.Message;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private String messageReceiverID,pref_nope;
...
//        messageSenderId = mAuth.getCurrentUser().getUid();
        ...
        messageSenderId = sharedPrefNomor.getString("phone", "");
        ...
        messageAdapter = new MessageAdapter(messageList,messageSenderId);
...
//                        }
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(ChatActivity.this, "Failed to send image. Try again", Toast.LENGTH_LONG).show();
                        }
                    }
                }
            });
    ...
    private void sendMessage() {
        ...
        if (TextUtils.isEmpty(message)){
            Toast.makeText(ChatActivity.this, "Tuliskan pesan Anda", Toast.LENGTH_LONG).show();
