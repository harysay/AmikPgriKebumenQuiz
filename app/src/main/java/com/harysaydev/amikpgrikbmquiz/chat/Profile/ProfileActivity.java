package com.harysaydev.amikpgrikbmquiz.chat.Profile;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private String CURRENT_STATE,pref_nope;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDatabaseReference.child(receiver_userID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                friendRequestReference.child(pref_nope)
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                friendsDatabaseReference.child(pref_nope)
                                        .addListenerForSingleValueEvent(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (!pref_nope.equals(receiver_userID)){ // condition for current owner / sender id
...
//                    startActivity(intent);
    ...
    private void declineFriendRequest() {
        ...
        friendRequestReference.child(pref_nope).child(receiver_userID).removeValue()
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            // delete from, receiver >> sender > values
                            friendRequestReference.child(receiver_userID).child(pref_nope).removeValue()
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
    ...
    private void unfriendPerson() {
        ...
        // delete from, sender >> receiver > values
        friendsDatabaseReference.child(pref_nope).child(receiver_userID).removeValue()
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {

                        if (task.isSuccessful()){
                            friendsDatabaseReference.child(receiver_userID).child(pref_nope).removeValue()
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
    ...
    private void acceptFriendRequest() {
        ...
        friendsDatabaseReference.child(pref_nope).child(receiver_userID).child("date").setValue(friendshipDate)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {

                        friendsDatabaseReference.child(receiver_userID).child(pref_nope).child("date").setValue(friendshipDate)
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        /**
    ...
    private void sendFriendRequest() {
        ...
        friendRequestReference.child(pref_nope).child(receiver_userID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            friendRequestReference.child(receiver_userID).child(pref_nope)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if (task.isSuccessful()){
                                                ...
                                                notificationData.put("from", pref_nope);
