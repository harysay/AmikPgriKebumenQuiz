package com.harysaydev.amikpgrikbmquiz.chat.Adapter;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder>{
    ...
    public MessageAdapter(List<Message> messageList, String nomer_hp) {
    ...
    public MessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_message_layout_chat, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder holder, int position) {
        ...
        if (from_message_TYPE.equals("text")){
            ...
            if (from_user_ID.equals(sender_UID)){
                holder.sender_text_message.setBackgroundResource(R.color.gray);
                ...
                holder.receiver_text_message.setBackgroundResource(R.color.colorPrimary);
