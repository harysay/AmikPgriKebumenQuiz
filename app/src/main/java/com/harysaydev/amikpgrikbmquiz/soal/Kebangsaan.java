 ...
 */
public class Kebangsaan extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "kebangsaan.db";//NAME of database stored in Assets folder
    private static final String Table_name = "kebangsaan";//name of table
    ...
    public Kebangsaan(Context context) {//constructor
