 ...
 */
public class Desainweb extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "desainweb.db";//NAME of database stored in Assets folder
    ...
    public Desainweb(Context context) {//constructor
