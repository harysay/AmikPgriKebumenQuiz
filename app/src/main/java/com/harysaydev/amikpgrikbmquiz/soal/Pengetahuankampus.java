 ...
 */
public class Pengetahuankampus extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "pengetahuankampus.db";//NAME of database stored in Assets folder
    private static final String Table_name = "pengetahuankampus";//name of table
    ...
    public Pengetahuankampus(Context context) {//constructor
