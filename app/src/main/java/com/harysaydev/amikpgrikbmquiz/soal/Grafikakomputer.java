 ...
 */
public class Grafikakomputer extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "grafikakomp.db";//NAME of database stored in Assets folder
    private static final String Table_name = "grafika";//name of table
    ...
    public Grafikakomputer(Context context) {//constructor
