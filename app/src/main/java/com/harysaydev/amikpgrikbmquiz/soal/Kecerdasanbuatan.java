 ...
 */
public class Kecerdasanbuatan extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "kecerdasanbuatan.db";//NAME of database stored in Assets folder
    private static final String Table_name = "kecerdasanbuatan";//name of table
    ...
    public Kecerdasanbuatan(Context context) {//constructor
...
//    }
    ...
    public String cekDuplikasi(String id_dariWeb)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        Cursor cDupKecerdasan = sqlite.rawQuery("SELECT " + uid + " FROM " + Table_name + " WHERE " + uid + " = " + id_dariWeb + "", null);//cursor to that query
        if (cDupKecerdasan.getCount()>0) {
            duplikasi = "true";
        }
        else {
