 ...
 */
public class Ekonomiakuntansi extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "ekonomiakuntansi.db";//NAME of database stored in Assets folder
    private static final String Table_name = "ekonomiakuntansi";//name of table
    ...
    public Ekonomiakuntansi(Context context) {//constructor
