 ...
 */
public class Desaingrafis extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "desaingrafis.db";//NAME of database stored in Assets folder
    private static final String Table_name = "desaingrafis";//name of table
    ...
    public Desaingrafis(Context context) {//constructor
