 ...
 */
public class StrukturData extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "strukturdata.db";//NAME of database stored in Assets folder
    ...
    public StrukturData(Context context) {//constructor
