 ...
 */
public class DesainwebUas extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "desainwebuas.db";//NAME of database stored in Assets folder
    private static final String Table_name = "desainweb";//name of table
    ...
    public DesainwebUas(Context context) {//constructor
