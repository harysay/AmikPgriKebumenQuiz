 ...
 */
public class Kepribadian extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "kepribadian.db";//NAME of database stored in Assets folder
    private static final String Table_name = "kepribadian";//name of table
    ...
    public Kepribadian(Context context) {//constructor
