 ...
 */
public class PemrogramanInternet extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "pemrogramaninternet.db";//NAME of database stored in Assets folder
    ...
    public PemrogramanInternet(Context context) {//constructor
