 ...
 */
public class PemrogramanInternetUas extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "pemrogramaninternetuas.db";//NAME of database stored in Assets folder
    private static final String Table_name = "pemroginternet";//name of table
    ...
    public PemrogramanInternetUas(Context context) {//constructor
