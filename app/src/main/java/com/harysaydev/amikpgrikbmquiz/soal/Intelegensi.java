 ...
 */
public class Intelegensi extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "intelegensi.db";//NAME of database stored in Assets folder
    private static final String Table_name = "intelegensi";//name of table
    ...
    private static final String Conclusion = "Conclusion";//name of column7
    ...
    public Intelegensi(Context context) {//constructor
