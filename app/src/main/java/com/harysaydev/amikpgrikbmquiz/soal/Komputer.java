 ...
 */
public class Komputer extends SQLiteOpenHelper {
    ...
    private static final String Question = "Question";//name of column3
    private static final String OptionA = "OptionA";//name of column4
    private static final String OptionB = "OptionB";//name of column5
    private static final String OptionC = "OptionC";//name of column6
    private static final String OptionD = "OptionD";//name of column7
    private static final String Answer = "Answer";//name of column8
    ...
    public Komputer(Context context) {//constructor
...
//    }
    ...
    public String readIdSoal(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        String id = "";//string that contains the required field  note that Ans is just a local string not related to Answer or Option...
        Cursor c = sqlite.rawQuery("SELECT " + uid + " FROM " + Table_name + " WHERE " + uid + " = " + i + "", null);//cursor to that query
        if (c.moveToFirst())
            id = c.getString(0);
        else
            id = "";
