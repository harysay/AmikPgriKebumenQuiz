 ...
 */
public class PemBerorientasiObjek extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "pbo.db";//NAME of database stored in Assets folder
    ...
    public PemBerorientasiObjek(Context context) {//constructor
