 ...
 */
public class StrukturDataUas extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "strukturdatauas.db";//NAME of database stored in Assets folder
    private static final String Table_name = "strukturdata";//name of table
    ...
    public StrukturDataUas(Context context) {//constructor
