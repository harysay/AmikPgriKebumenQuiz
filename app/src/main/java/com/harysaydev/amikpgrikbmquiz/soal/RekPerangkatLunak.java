 ...
 */
public class RekPerangkatLunak extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "rpl.db";//NAME of database stored in Assets folder
    private static final String Table_name = "rekayasa";//name of table
    ...
    public RekPerangkatLunak(Context context) {//constructor
