 ...
 */
public class JaringanKomputer extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.harysaydev.amikpgrikbmquiz/databases/";
    private static final String Database_name = "jaringankomputer.db";//NAME of database stored in Assets folder
    private static final String Table_name = "jaringankomputer";//name of table
    ...
    public JaringanKomputer(Context context) {//constructor
